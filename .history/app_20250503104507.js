...
function somarNumeros() {
  const numeros = [
  Number(document.getElementById('task10-1'),
  Number(document.getElementById('task10-2'),
  Number(document.getElementById('task10-3'),
  Number(document.getElementById('task10-4'),
  Number(document.getElementById('task10-5')
  ];

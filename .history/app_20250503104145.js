...
function somarNumeros() {
  const numeros = [
  numero1 = document.getElementById("task10-1"),
  numero2 = document.getElementById("task10-2"),
  numero3 = document.getElementById("task10-3"),
  numero4 = document.getElementById("task10-4"),
  numero5 = document.getElementById("task10-5");
];
  let somaTotal;

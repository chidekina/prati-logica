...
function somarNumeros() {
  ...
  const numero2 = document.getElementById("task10-1");
  const numero3 = document.getElementById("task10-1");
  const numero4 = document.getElementById("task10-1");
  const numero5 = document.getElementById("task10-1");
}
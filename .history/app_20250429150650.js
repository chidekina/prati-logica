...
function classificacaoIMC() {
    ...
    answer5.innerHTML = `O seu IMC  é de ${IMC} classificado como "${classificacao}"`;
}

function classificacaoTriangulo() {
    const primeiroLado = document.getElementById('ladoA');
    const primeiroLado = document.getElementById('ladoB');
    const primeiroLado = document.getElementById('ladoC');
}
...
function checkboxCheck (checbox) {
    let mood = document.getElementsByClassName("checbox-mood");

    for (let i = 0; i < mood.length)
...
function nivelHumor() {
    ...
    const check2 = document.getElementById('option1');
    const check3 = document.getElementById('option1');
